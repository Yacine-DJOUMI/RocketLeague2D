...
public class Equipe {
    ...
    public Equipe(String nomEquipe, float init_position_x, float init_position_y, int init_size_x, int init_size_y,float cageX,float cageY) throws SlickException{
        this.nom = nomEquipe;      
